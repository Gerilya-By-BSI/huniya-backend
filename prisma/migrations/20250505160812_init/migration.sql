...
CREATE TABLE "core_banking_users" (
    ...
    "num_of_loans" DOUBLE PRECISION NOT NULL,
    "type_of_loans" TEXT NOT NULL,
    "delay_from_due_date" INTEGER NOT NULL,
    "num_of_delayed_payments" DOUBLE PRECISION NOT NULL,
    "changed_credit_limit" DOUBLE PRECISION NOT NULL,
    "num_credit_inquiries" DOUBLE PRECISION NOT NULL,
    "outstanding_debt" DOUBLE PRECISION NOT NULL,
    "credit_history_age" DOUBLE PRECISION NOT NULL,
    ...
    "payment_behaviour" INTEGER NOT NULL,
